...
* Internet Explorer - A polyfill script should be used: `tagify.polyfills.min.js` (in `/dist`) ***([this fork](https://github.com/krzyko/tagify) has a low-effort and low-priority IE11 support which will be maintained for a while)***
